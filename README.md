...
* Система ролей для пользователей.
  + Пользователи с привилегиями могут изменять данные ресторана и удалять их.
  + Пользователи с привилегиями также получают доступ к секретной информации.
  + Обычные пользователи могут только получить доступную им информацию. 
