...
* Авторизация пользователя.
  + Авторизованный пользователь получает доступ аналитическим данным ресторана.
  + Неавторизованный пользователь может только зарегистрироваться и залогиниться.
* Управление пользователями и сущностями, которые относятся к предметной области(CRUD).
* Просмотр аналитических данных связанных с рестораном.
* Система ролей для пользователей.
  + Обычный пользователь может просматривать только часть данных ресторана (Меню, информация о сотрудниках, подробная информация элементов меню).
  + Сотрудник ресторана имеет доступ ко всей информации (Посетители, заказы, логи).
  + Администратор имеет возможность изменять данные ресторана. Имеет право блокировать пользователей.  
